...
class UserSessionsControllerTest < ActionController::TestCase
  ...
  test "should create user_session" do
    assert_difference('UserSession.count') do
      post :create, user_session: { address: @user_session.address, ip_address: @user_session.ip_address, latitude: @user_session.latitude, longitude: @user_session.longitude, name: @user_session.name }
    end
  ...
  test "should update user_session" do
    put :update, id: @user_session, user_session: { address: @user_session.address, ip_address: @user_session.ip_address, latitude: @user_session.latitude, longitude: @user_session.longitude, name: @user_session.name }
    assert_redirected_to user_session_path(assigns(:user_session))
  end
